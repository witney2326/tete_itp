            ...
            <div class="container-fluid">
                ...
                <div class="card1">
                    ...
                    <div class="card-border">
                        ...
                        <div class="card-body">
                            <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="OSS_reports_registration_pa.php" method ="GET" >
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <button type="submit" class="btn btn-outline-primary w-md" name="Submit" value="Submit" onclick="return Validate()">Submit</button>
