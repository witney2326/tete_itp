                                ...
                                <div class="tab-pane active" id="home-1" role="tabpanel">
                                    <p class="mb-0">
                                        ...
                                        <div class="card-border">
                                            <div class="card-body">
                                                <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="works_tracking_verified_completed_projects_filter3.php" method ="POST" >
                                                    <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <h7 class="card-title mt-0"></h7>
                                                        ...
                                                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                            ...
                                                            <tbody>
                                                                <?Php
                                                                    $query="select tprojects.pID,tprojects.phhcode,tprojects.pstartdate,tprojects.pfinishdate,tprojects.pcontractorID,tprojects.pstatus from tprojects inner join households on tprojects.phhcode = households.hhcode where ((tprojects.pstatus = '06') and (tprojects.pCompletenessVerified = '1') and (households.pa='$admin_post') and (households.locality='$bairro'))";
