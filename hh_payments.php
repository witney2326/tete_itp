...
<head>
    <title>Payments|Household Contributions</title>
                ...
                <div class="row">
                    <div class="col-9">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Applicant's Contributions</h4>
                            ...
                            <div class="card border border-success">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="hh_payments_update.php">
                                        ...
                                        <div class="row mb-1">
                                            <label for="area" class="col-sm-2 col-form-label">BL Number</label>
                                            <input type="text" class="form-control" id="area" name="area" value ="" style="max-width:30%;" readonly>
                                        
                                            <label for="blockname" class="col-sm-2 col-form-label">Locality</label>
                                            <input type="text" class="form-control" id="blockname" name="blockname" value ="" style="max-width:30%;" readonly>
                                        </div>
                                        ...
                                        <div class="row mb-1">
                                            ...
                                            <input type="text" class="form-control" id="poption" name="poption" value ="" style="max-width:30%;" readonly>
                                        </div>
                ...
                <div class="row">
                    <div class="col-9">
                        ...
                        <div class="card-header bg-transparent border-primary">
                            <h5 class="my-0 text-primary">Applicant's Payments Record</h5>
                        </div>
                        <div class="card-body">
