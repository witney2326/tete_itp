...
<head>
    <title><?php echo $language["Filtered_Applicants_With_Approved_Payments"]?></title>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18"><?php echo $language["Filtered_Applicants_With_Approved_Payments"]?></h4>
                                    ...
                                    <table id="datatable-buttons" class="table table-bordered dt-responsive  nowrap w-100">
                                        ...
                                        <tbody>
                                            <?Php
                                                ...
                                                where ((tpayments.pApproved ='1') and (locality = '$bairro')) group by tpayments.hhCode";
