...
<head>
    <title><?php echo $language["Contribute_For_Service"]?></title>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18"><?php echo $language["Contribute_For_Service"]?></h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="index_check.php"><?php echo $language["Dashboard"]?></a></li>
                                    <li class="breadcrumb-item active"><?php echo $language["Contribute_For_Service"]?></li>
                                </ol>
                            </div>
                                ...
                                <div class="tab-pane active" id="home-1" role="tabpanel">
                                    <p class="mb-0">
                                        ...
                                        <div class="card-border">
                                            <div class="card-body">
                                                <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="contribute_for_service_payments_filter3.php" method ="POST" >
                                                    <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <h7 class="card-title mt-0"></h7>
                                                        ...
                                                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                            ...
                                                            <tbody>
                                                                <?Php
                                                                    $query="select * from households where ((pa='$admin_post') and (locality='$bairro') and (selected_product <> '04') and (enrolled = '1') and (product_approved = '1') and (agree_tcs = '1'))";
                                                                    ...
                                                                    { 
                                                                        $balance = ($row["amount_owing"] - $row["tamount_paid"]);
                                                                        ...
                                                                        echo "<tr>\n";
                                                                            ...
                                                                            echo "<td>\t\t$balance_display</td>\n";
                                                                    
                                                                            echo "<td>                                               
                                                                            <a href=\"hh_View.php?id=".$row['hhcode']."\"><i class='far fa-eye' title='$language[View_Applicant]' style='font-size:18px;color:purple'></i></a> 
                                                                            <a href=\"hh_payments.php?id=".$row['hhcode']."\"><i class='fas fa-comment-dollar' title='$language[Record_Household_Payment]' style='font-size:18px;color:green'></i></a> 
