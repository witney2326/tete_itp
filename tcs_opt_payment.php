                            ...
                            <div class="card1">
                                ...
                                <div class="card-border">
                                    <div class="card-body">
                                        ...
                                        <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="tcs_opt_payment_filter2.php" method ="POST" >
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <select class="form-select" name="bairro" id="bairro" placeholder="Select Bairro">
                                                    <option ></option>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <h7 class="card-title mt-0"></h7>
                                                ...
                                                <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                    ...
                                                    <tbody>
                                                        <?Php
                                                            $query="select * from households where ((selected_product <> '04') and (enrolled = '1') and (product_approved = '1'))";
                                                            
                                                            if ($result_set = $link->query($query)) {
                                                            while($row = $result_set->fetch_array(MYSQLI_ASSOC))
                                                            { 
                                                                if ($row["selected_product"] == '04'){$prod = 'None';}else{$prod = pname($link,$row["selected_product"]);}
                                                            ...
                                                            echo "<tr>\n";
                                                                ...
                                                                echo "<td>\t\t$prod</td>\n";
                                                                echo "<td>".number_format($row["amount_owing"],2)."</td>\n";
                                                                echo "<td>".number_format($row["tamount_paid"],2)."</td>\n";
