                ...
                <div class="row">
                    <div class="col-9">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Household Contributions</h4>
                                    ...
                                    <form method="POST" action="hh_payments_update_hh.php">
                                        ...
                                        if (($enrolled == '1') and ($paymentOption <> '00'))
                                        {
                                            echo '<div class="row mb-1">';
                                                ...
                                                echo '<input type="text" class="form-control" id="pref" name="pref"  style="max-width:30%;">';
                                                
                                                echo '<label for="amount" class="col-sm-2 col-form-label">Amount</label>';
                                                echo '<input type="text" class="form-control" id="amount" name="amount"  style="max-width:30%;">';
                                            echo '</div>';

                                                                                    
                                            echo '<div class="row justify-content-end">';
                                                echo '<div>';
                                                    echo '<button type="submit" class="btn btn-btn btn-outline-success w-md" name="Submit" value="Submit">Save Payment</button>';
                                                echo '</div>';
                                            echo '</div>';
                                        }
                                        ?>
