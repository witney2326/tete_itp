                        ...
                        <div class="w-100">
                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="my-auto">
                                    ...
                                    <div class="mt-4">
                                        <form class="needs-validation" novalidate action="auth-register-hh3.php" method="POST">
                                            ...
                                            <label for="ward" class="form-label">Ward</label>
                                                <select class="form-select" name="ward" id="ward"  required>
                                                    <option></option>
                                                        ...
                                                        <?php                                                           
                                                           $dis_fetch_query = "SELECT id,wname FROM wards where constituency = '$con'";                                                  
                                            ...
                                            <div class="mt-4 d-grid">
                                                <button class="btn btn-primary waves-effect waves-light" type="submit">Submit Ward</button>
                                            </div>
