...
session_start();
     ...
     $super_structure_order = $_POST["super_structure_order"]; //check here
    ...
    $_SESSION['aemail'] = $email;
        ...
        $sql = "INSERT INTO households (hhcode, hhname, hh_gender,blno, plot,pa, locality, landmark, hh_status,phone1,phone2,total_ordered, supestructure, wall_tiles_t1,mirror_t1,solar_light_t1,prompted_by,rooms_rented,no_pple_premises,no_pple_premises_a_males,no_pple_premises_a_females,no_pple_premises_children,current_toilet,selected_product,ready_selection,need_tg,email)
        VALUES ('$hhcode','$applicant_name','$gender','$blno','$plotno','$adminpost','$bairro','$landmark','$hh_status','$phoneno1','$phoneno2','$no_toilets_order','$super_structure_order','$toilet1_wall_tiles','$toilet1_mirror','$toilet1_solar_light','01','$no_rooms_rented','$no_pple_at_premises',
