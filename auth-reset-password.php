                        ...
                        <div class ="card-border">
                            <div class ="card-body">
                                        ...
                                        <div class="p-2">
                                            ...
                                            <form class="form-horizontal" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                                ...
                                                <div class="mb-3 <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                                                    <label for="new_password">New Password (Nova palavra-passe)</label>
                                                ...
                                                <div class="mb-3 <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
                                                    <label for="userpassword">Confirm Password (Confirmar a palavra-passe)</label>
                                ...
                                <div class="mt-5 text-center">
                                    <p>Remember It? Recordar? <a href="auth-login.php" class="fw-medium text-primary"> Sign In here -- Iniciar sessão aqui</a> </p>
                                    <p>© <script>
