                        ...
                        <div class="col-xl-12">
                            <div class="card1">
                                ...
                                <div class="card-border">
                                    <div class="card-body">
                                        <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="tcs_opt_payment_filter3.php" method ="POST" >
                                            <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <h7 class="card-title mt-0"></h7>
                                                ...
                                                <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                    ...
                                                    <tbody>
                                                        <?Php
                                                            $query="select * from households where ((pa='$admin_post') and (locality='$bairro') and (selected_product <> '00') and (enrolled = '1') and (product_approved = '1'))";
