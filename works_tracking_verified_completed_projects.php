                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="card-body">
                                                        ...
                                                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                            ...
                                                            <tbody>
                                                                <?Php
                                                                    $query="select * from tprojects where ((pstatus = '06') and (pCompletenessVerified = '1'))";                                                               
                                                                    ...
                                                                    echo "<tr>\n";
                                                                        ...
                                                                        echo "<td>                                               
                                                                            ...
                                                                            <a href=\"completion certificate.php?id=".$row['pID']."\"><i class='fa fa-print' title='$language[Completion_Certificate]' style='font-size:18px;color:black'></i></a> 
                                                                        </td>\n";
