        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <a href="register-applicant_self.php" class="waves-effect">
                        <i class="fa fa-home" style="color:black"></i><span class="badge rounded-pill bg-info float-end"></span>
                        <span key="t-dashboards"><?php echo $language["Applicant_Registration"];?></span>
                    </a>
                ...
                <li>
                    <a href="auth-register-staff.php" class="waves-effect"> 
                        ...
                        <span key="t-dashboards"><?php echo $language["Client_Registration"];?></span>
                    </a>
                ...
                <li>
                    ...
                    <i class="fa fa-tasks"></i><span class="badge rounded-pill bg-info float-end"></span>
                        <span key="t-dashboards"><?php echo $language["Supervisor_Registration"];?></span>
                    </a>
                ...
                <li>
                    ...
                    <i class="fa-solid fa-hammer" style="color:black" ></i><span class="badge rounded-pill bg-info float-end"></span>
                        <span key="t-dashboards"><?php echo $language["Contractor_Registration"];?></span>
                    </a>
