                ...
                <div class="row">
                    ...
                    <div class="card1">
                        ...
                        <div class="card-border">
                            ...
                            <div class="card-body">
                                <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="OSS_reports_registration_verified_hhs_bairro.php" method ="GET" >
                                    <div class="col-12">
                        ...
                        <div class="card-body">
                            ...
                            <table id="datatable-buttons" class="table table-bordered dt-responsive  nowrap w-100">
                                ...
                                <tbody>
                                    <?Php
                                        $query="SELECT * FROM households where ((pa = '$admin_post') and (enrolled = '1') and (deleted = '0'))";
