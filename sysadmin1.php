...
<head>
    <title><?php echo $language["User_Management"];?></title>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18"><?php echo $language["User_Management"];?></h4>
                                            ...
                                            <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                ...
                                                <tbody>
                                                    <?Php
                                                        ...
                                                        { 
                                                            if ($row['ustatus'] == '1'){$ustatus =$language["Active"];}else{$ustatus = $language["Not_Actived"];}
                                                            echo "<tr>";
                                                            echo "<td>".$row['id']."</td>";
