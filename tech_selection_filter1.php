                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                ...
                                <div class="card-border">
                                    <div class="card-body">
                                        <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="tech_selection_filter2.php" method ="POST" >
                                            <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <h7 class="card-title mt-0"></h7>
                                                ...
                                                <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                    ...
                                                    <tbody>
                                                        <?Php
                                                            $query="select * from households where ((con = '$constituency') and  (selected_product <> '00') and (enrolled = '1') and (product_approved = '0'))";
                                                            ...
                                                            if ($result_set = $link->query($query)) {
                                                                ...
                                                                echo "<tr>\n";
                                                                    ...
                                                                    <a onClick=\"javascript: return confirm('Are You Sure You want To Approve This Technology Selection For The Household?');\" href=\"tech_selected_approval.php?id=".$row['hhcode']."\"><i class='fa fa-check' title='$language[Approve_Tech_Selection]' style='font-size:18px;color:green'></i></a>
                                                                    </td>\n";
