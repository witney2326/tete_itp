...
<head>
    <title><?php echo $language["Supervisor_Registration"];?></title>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-column h-100">
                                            ...
                                            <div class="my-auto">
                                                ...
                                                <div>
                                                    <p><center><h5 class="text-default">Register Supervisor Account</h5></center></p>
                                                    <p><center><h5 class="text-primary">Registrar conta de supervisor</h5></center></p>
