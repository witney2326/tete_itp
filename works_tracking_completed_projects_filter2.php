...
<head>
    <title><?php echo $language["Completed_Works"]?></title>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18"><?php echo $language["Completed_Works"];?></h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="index.php"><?php echo $language["Dashboard"]?></a></li>
                                    <li class="breadcrumb-item active"><?php echo $language["Completed_Works"];?></li>
                                </ol>
                            </div>
                                        ...
                                        <div class="card-border">
                                            <div class="card-body">
                                                <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="works_tracking_completed_projects_filter3.php" method ="POST" >
                                                    <div class="col-12">
                                                        <label for="admin_post" class="form-label"><?php echo $language["Amin_Post"];?></label>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="card-header bg-transparent border-primary">
                                                    <h5 class="my-0 text-primary"><?php echo $language["Completed_Works"];?></h5>
                                                </div>
                                                <div class="card-body">
                                                <h7 class="card-title mt-0"></h7>
                                                        ...
                                                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                            ...
                                                            <tbody>
                                                                <?Php
                                                                    $query="select tprojects.pID,tprojects.phhcode,tprojects.pstartdate,tprojects.pfinishdate,tprojects.pcontractorID,tprojects.pstatus from tprojects inner join households on tprojects.phhcode = households.hhcode where ((tprojects.pstatus = '05') and (households.pa='$admin_post') and (households.locality='$bairro'))";
                                                                    ...
                                                                    echo "<tr>\n";
                                                                        ...
                                                                        <a href=\"hh_View.php?id=".$row['phhcode']."\"><i class='far fa-eye' title='$language[View_Applicant]' style='font-size:18px;color:purple'></i></a> 
                                                                            <a href=\"hh_project_verify_completness.php?id=".$row['pID']."\"><i class='fas fa-check-circle' title='$language[Verify_Toilet_Works]' style='font-size:18px;color:green'></i></a> 
                                                                        </td>\n";
                                                                    echo "</tr>\n";
                                                                    }
                                                                    $result_set->close();
