...
<head>
    <title><?php echo $language["Application_Settings"];?></title>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18"><?php echo $language["Application_Settings"];?></h4>
                            ...
                            <div class="card-border1">
                                ...
                                <h7 class="card-title mt-0"></h7>
                                        ...
                                        <table id="mytable" class="table table-bordered dt-responsive  nowrap w-100">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th><?php echo $language["Parameter_ID"];?></th>
                                                    <th><?php echo $language["Parameter"];?></th>
                                                    <th><?php echo $language["Parameter_Value"];?></th>
